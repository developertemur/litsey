...
namespace litsey.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(litseydbContext context)
        {
            _context = context;
        }
        ...
        {
            var litseydbContext = _context.Students.Include(s => s.Group);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Nomi,Surname,Sharif,Manzil,GroupId")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
